...
@implementation RCKCodabarCodeGenerator
-(void)setCodeValue:(NSString*) codeValue {
    ...
    NSInteger res = codekit_code_create_codabar([codeValue cStringUsingEncoding:NSUTF8StringEncoding], opts, &desc);
    if (res < 0) {
...
- (NSDictionary *)customAttributes
{
    ...
    dict[@"codeValue"] = @{
            ...
            kCIAttributeDescription: @"The codabar code to convert to bar code",
   };
    return dict;
}
@end

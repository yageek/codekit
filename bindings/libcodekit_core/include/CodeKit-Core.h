 ...
 */
int8_t codekit_code_create_ean8(const char *content, struct CodeKitCodeDescriptor *value);

/**
 * Create a descriptor for EAN8 code
 */
int8_t codekit_code_create_ean13(const char *content, struct CodeKitCodeDescriptor *value);

/**
 * Create a descriptor for a Code39 code.
 */
int8_t codekit_code_create_code39(const char *content, struct CodeKitCodeDescriptor *value);

/**
 * Create a descriptor for a Code93 code.
 */
int8_t codekit_code_create_code93(const char *content, struct CodeKitCodeDescriptor *value);

/**
 * Create a descriptor for a Codabar code.
 */
int8_t codekit_code_create_codabar(const char *content, struct CodeKitCodeDescriptor *value);

/**
 * Create a descriptor for a Interleaved code.
 */
int8_t codekit_code_create_i2of5(const char *content, struct CodeKitCodeDescriptor *value);

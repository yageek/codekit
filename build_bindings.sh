...
then
    ...
    # libtool -static -o bindings/${LIBRARY_NAME}/lib/iOS/${LIBRARY_NAME}.a \
    #              ./target/aarch64-apple-ios/debug/${LIBRARY_NAME}.a \
    #               ./target/aarch64-apple-ios-sim/debug/${LIBRARY_NAME}.a \
    #              ./target/x86_64-apple-ios/debug/${LIBRARY_NAME}.a
...
# xcodebuild -create-xcframework  -library codekit-core/target/x86_64-apple-ios/release/libcodekit_core.a  -library codekit-core/target/aarch64-apple-ios-sim/release/libcodekit_core.a -output bindings/libcodekit_core/lib/iOS/debug/CodeKitCore.xcframework